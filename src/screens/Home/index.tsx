...
import { Alert, FlatList, Modal, ActivityIndicator, View, TouchableWithoutFeedbackComponent } from 'react-native';
...
export function Home() {
  ...
  async function handleSignOut() {
    try {
      ...
      Alert.alert('Erro SignOut', 'Ocorreu um erro ao fazer SignOut');
      console.log(error);
    }
  }
